...
| 26.2 | [v1.1.1](https://github.com/Dahesor/DaBsu-Batch-Spawner-Utils/releases/tag/v1.1.1) |
| 26.3 | [v1.2.0](https://github.com/Dahesor/DaBsu-Batch-Spawner-Utils/releases/tag/v1.2.0) |
...
This is the same logic as the `nbt=` selector argument. You will be prompted to enter a compound tag, and the system will select all spawners that have at least one entity containing the tag you entered. For example, `{id:"minecraft:zombie"}` will select all spawners that spawn zombies.
