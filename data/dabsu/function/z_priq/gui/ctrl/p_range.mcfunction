...
#Get Diag.
scoreboard players operation #step_x calc.dabsu *= #step_x calc.dabsu
scoreboard players operation #step_z calc.dabsu *= #step_z calc.dabsu
scoreboard players operation #step_x calc.dabsu += #step_z calc.dabsu
scoreboard players operation #math.sqrt calc.dabsu = #step_x calc.dabsu
execute store result score #step_x calc.dabsu run function dabsu:z_priq/gui/boot/sphere/math/sqrt


#Get Final Range as #step_x
scoreboard players add #step_x calc.dabsu 80
scoreboard players operation #step_x calc.dabsu /= #100 calc.dabsu


data modify storage dabsu:run proceed set value {command:"execute as @e[type=marker,tag=dabsu.marker,distance=..0.1] at @s run function dabsu:z_priq/gui/edit/player_range"}
