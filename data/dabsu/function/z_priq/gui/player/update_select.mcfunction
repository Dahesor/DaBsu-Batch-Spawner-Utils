...
execute if entity @s[tag=dabsu.ctrl.count] run return run function dabsu:z_priq/gui/util/range_deselect
execute if entity @s[tag=dabsu.ctrl.p_range] run return run function dabsu:z_priq/gui/util/range_deselect