...
execute store result score #case calc.dabsu as @n[type=#dabsu:quick_display,distance=..0.45,tag=dabsu.gui_edit,tag=dabsu.ctrl.range] run function dabsu:z_priq/gui/player/validate_range
