data merge entity @s {block_state:{id:"green_concrete"},Glowing:0b,glow_color_override:16777215,Tags:["dabsu.gui_edit","dabsu.displayer","dabsu.temp","dabsu.gui_edit.sr","dabsu.ctrl.range","dabsu.ctrl","dabsu.ctrl.marker"],brightness:{block:15,sky:15}}
