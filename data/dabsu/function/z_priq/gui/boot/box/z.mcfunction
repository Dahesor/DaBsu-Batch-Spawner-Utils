data merge entity @s {block_state:{id:"white_concrete"},Glowing:0b,glow_color_override:16745347,Tags:["dabsu.gui_edit","dabsu.displayer","dabsu.temp","dabsu.gui_edit.sr"],brightness:{block:15,sky:15}}
...
execute if score #y calc.dabsu matches 0 run data merge entity @s {Glowing:1b,block_state:{id:"pink_concrete"},glow_color_override:14050960}