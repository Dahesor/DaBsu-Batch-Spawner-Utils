data merge entity @s {block_state:{Name:"white_concrete"},Glowing:0b,glow_color_override:16745347,Tags:["dabsu.gui_edit","dabsu.displayer","dabsu.temp"],brightness:{block:15,sky:15}}
