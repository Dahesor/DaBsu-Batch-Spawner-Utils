data merge entity @s {block_state:{id:"green_concrete"},Tags:["dabsu.gui_edit","dabsu.displayer","dabsu.temp","dabsu.gui_edit.sc","dabsu.ctrl.count","dabsu.ctrl","dabsu.ctrl_native"],brightness:{block:15,sky:15}}
