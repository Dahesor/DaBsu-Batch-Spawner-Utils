...
execute store result score #current calc.dabsu run data get storage dabsu:run shape.list[0].translation[2] 10000
scoreboard players operation #current calc.dabsu *= #scale calc.dabsu
execute store result storage dabsu:run shape.list[0].translation[2] float 0.0001 run scoreboard players get #current calc.dabsu

execute store result score #current calc.dabsu run data get storage dabsu:run shape.list[0].scale[2] 4800
scoreboard players operation #current calc.dabsu *= #scale calc.dabsu
execute store result storage dabsu:run shape.list[0].scale[2] float 0.0001 run scoreboard players get #current calc.dabsu
