data modify storage dabsu:run run set value {transformation:[],Tags:["dabsu.gui_edit","dabsu.displayer","dabsu.temp","dabsu.gui_edit.pr"],block_state:{id:"yellow_concrete"},glow_color_override:16761856,brightness:{block:15,sky:15}}
