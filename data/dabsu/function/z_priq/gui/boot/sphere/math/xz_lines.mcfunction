...
data modify storage dabsu:run run set value {transformation:[],data:{shapes:{list:[]}},Tags:["dabsu.gui_edit","dabsu.displayer","dabsu.temp","dabsu.gui_edit.pr"],block_state:{id:"blue_concrete"},Glowing:1b,glow_color_override:13311,brightness:{block:15,sky:15}}
