...
data modify storage dabsu:run dialog.dialog.body[6].contents.text set from storage dabsu:run lang.this.trial_copy
data modify storage dabsu:run dialog.dialog.body[6].contents.hover_event.value set from storage dabsu:run lang.this.trial_copy_hover
