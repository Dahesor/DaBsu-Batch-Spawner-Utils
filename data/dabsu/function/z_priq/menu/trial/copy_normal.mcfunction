...
#Validate
execute unless data storage dabsu:run trial.normal_config run return fail
...
#Convert
data modify storage dnt:ram in set from storage dabsu:run trial.normal_config
