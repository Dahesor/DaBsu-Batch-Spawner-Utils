...
execute unless data storage dabsu:user data[0].settings{disableDisplayTiles:true} positioned ~ ~ ~ align xyz positioned ~0.5 ~0.5 ~0.5 run function dabsu:z_priq/gui/boot
data modify storage dabsu:run data set from entity @s data