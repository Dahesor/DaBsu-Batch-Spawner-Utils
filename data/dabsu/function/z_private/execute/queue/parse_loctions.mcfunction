...
execute if data storage dabsu:run exe{work_type:"restart"} run function dabsu:z_private/execute/queue/restart
execute if data storage dabsu:run exe{work_type:"restart"} run return 1
