data modify storage dabsu:run entity_data merge from storage dabsu:run run
data remove storage dabsu:run entity_data.UUID
data remove storage dabsu:run entity_data.Pos
data remove storage dabsu:run entity_data.Rotation
