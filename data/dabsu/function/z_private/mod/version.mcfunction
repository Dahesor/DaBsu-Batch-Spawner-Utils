...
data modify storage dabsu:sys version set value 10
data modify storage dabsu:sys VersionName set value "1.1.0"
data modify storage dabsu:sys MCVersionRange set value "Minecraft Java 26.1"
