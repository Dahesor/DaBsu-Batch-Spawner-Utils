...
data modify storage dabsu:sys version set value 11
data modify storage dabsu:sys VersionName set value "1.1.1"
data modify storage dabsu:sys MCVersionRange set value "Minecraft Java 26.1~26.2"
