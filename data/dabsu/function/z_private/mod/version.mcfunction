...
data modify storage dabsu:sys version set value 7
data modify storage dabsu:sys VersionName set value "1.0.7"
data modify storage dabsu:sys MCVersionRange set value "Minecraft Java 1.21.11"
