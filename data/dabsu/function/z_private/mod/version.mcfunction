...
data modify storage dabsu:sys version set value 20
data modify storage dabsu:sys VersionName set value "1.2.0"
data modify storage dabsu:sys MCVersionRange set value "Minecraft Java 26.3"
