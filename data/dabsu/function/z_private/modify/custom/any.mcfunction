...
execute if data storage dabsu:run stack[0].data{for_each:0} run return run function dabsu:z_private/modify/custom/__per_block with storage dabsu:run stack[0].data
