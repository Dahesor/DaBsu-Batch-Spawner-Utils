...
execute if items entity @s weapon.offhand *[custom_data~{dabsu:{cart:{stored:{}}}}] run return run function dabsu:z_private/cart/player/obtain
...
execute if items entity @s weapon.offhand *[custom_data~{dabsu:{cart:{button:{}}}}] run return run function dabsu:z_private/cart/player/button