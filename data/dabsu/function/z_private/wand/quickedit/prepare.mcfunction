...
function dabsu:z_private_dialog/templates/single_home
...
function dabsu:z_private_dialog/lines/spawner_top_info with storage dabsu:run run
data modify storage dabsu:run dialog.dialog.body[0].description.contents set from storage dabsu:run final
data modify storage dabsu:run dialog.dialog.body[0].item.components set from block ~ ~ ~ components
