data modify storage dabsu:run dialog.dialog set value {type:"minecraft:multi_action",\
    ...
    columns:4,can_close_with_escape:true,after_action:"none",pause:false,\
    inputs:[\
    ...
    actions:[\
        ...
        {label:"COPY TO CLIPBOARD",tooltip:"COPY CLIPBOARD TIP",action:{type:"copy_to_clipboard",value:""},width:110},\
        ...
        {label:{translate:"selectServer.edit",color:"green"},action:{type:"dynamic/run_command",template:'-$(none)'},width:140},\
        {label:{translate:"gui.cancel"},action:{type:"run_command",command:"/trigger trigger.dabsu set 1"},width:140},\
    ]\
}
...
data modify storage dabsu:run dialog.dialog.actions[2].label set from storage dabsu:run lang.this.bt_copy_entity_nbt
...
data modify storage dabsu:run dialog.dialog.actions[2].tooltip set from storage dabsu:run lang.this.bt_copy_entity_nbt_tip
data modify storage dabsu:run dialog.dialog.actions[3].tooltip set from storage dabsu:run lang.this.temp_potential_3_tip