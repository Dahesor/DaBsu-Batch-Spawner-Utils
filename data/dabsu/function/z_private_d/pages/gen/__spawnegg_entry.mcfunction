data modify storage dabsu:run dialog.dialog.body append value {type:"item",description:{width:30,contents:[" ",{text:" ✔ ",underlined:true,color:"green",click_event:{action:"run_command",command:"/trigger input.dabsu set 100"},hover_event:{action:"show_text",value:[""]}}]}}
