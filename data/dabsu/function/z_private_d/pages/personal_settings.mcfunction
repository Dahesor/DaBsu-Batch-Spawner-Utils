...
execute unless data storage dabsu:user data[0].settings{useNBTPrettyPrint:true} run data modify storage dabsu:run dialog.dialog.body append value {type:"plain_message",contents:{text:"pretty nbt: §nOff",color:"red",hover_event:{action:"show_text",value:{text:"..."}},click_event:{action:"run_command",command:"/trigger trigger.dabsu set 1333"}},width:300}
execute if data storage dabsu:user data[0].settings{useNBTPrettyPrint:true} run data modify storage dabsu:run dialog.dialog.body append value {type:"plain_message",contents:{text:"pretty nbt: §nOn",color:"green",hover_event:{action:"show_text",value:{text:"..."}},click_event:{action:"run_command",command:"/trigger trigger.dabsu set 1334"}},width:300}
...
execute unless data storage dabsu:user data[0].settings{useNBTPrettyPrint:true} run data modify storage dabsu:run dialog.dialog.body[5].contents.text set from storage dabsu:run lang.this.poption_pretty_nbt_off
execute if data storage dabsu:user data[0].settings{useNBTPrettyPrint:true} run data modify storage dabsu:run dialog.dialog.body[5].contents.text set from storage dabsu:run lang.this.poption_pretty_nbt_on
...
data modify storage dabsu:run dialog.dialog.body[5].contents.hover_event.value set from storage dabsu:run lang.this.poption_pretty_nbt_tip
