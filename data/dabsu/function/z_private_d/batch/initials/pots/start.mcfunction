...
execute unless score disableCustomname Option.dabsu matches -1 if data storage dabsu:run spawner.SpawnPotentials[0].data.entity.CustomName run data modify storage dabsu:run dialog.dialog.actions[-2].label[2] set from storage dabsu:run spawner.SpawnPotentials[0].data.entity.CustomName
