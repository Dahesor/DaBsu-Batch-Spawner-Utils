...
execute unless function dabsu:z_private_d/batch/read/validate_number run return run scoreboard players get #num calc.dabsu
...
execute unless data storage dabsu:run {string_to_num:""} run function dabsu:z_private_d/batch/read/string_to_num
