...
execute if score #trigger trigger.dabsu matches 1005 run return run function dabsu:z_private_d/pages/obtain_home
...
execute if score #trigger trigger.dabsu matches 1008 run return run function dabsu:z_private_d/pages/personal_settings
