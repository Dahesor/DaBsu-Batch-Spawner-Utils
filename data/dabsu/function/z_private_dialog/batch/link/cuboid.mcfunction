...
function dabsu:z_private_dialog/batch/read/vec3
...
execute if data storage dabsu:run form{index:1} run function dabsu:select/cuboid/set
execute if data storage dabsu:run form{index:2} run function dabsu:select/cuboid/add