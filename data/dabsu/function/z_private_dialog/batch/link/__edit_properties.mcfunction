...
$execute unless data storage dabsu:run form{MaxNearbyEntities:""} store result score #validate2 calc.dabsu run function dabsu:z_private_dialog/batch/link/__set_number {num:"$(MaxNearbyEntities)"}
...
scoreboard players set #validate2 calc.dabsu 0
$execute unless data storage dabsu:run form{MaxSpawnDelay:""} store result score #validate2 calc.dabsu run function dabsu:z_private_dialog/batch/link/__set_number {num:"$(MaxSpawnDelay)"}
...
scoreboard players set #validate2 calc.dabsu 0
$execute unless data storage dabsu:run form{MinSpawnDelay:""} store result score #validate2 calc.dabsu run function dabsu:z_private_dialog/batch/link/__set_number {num:"$(MinSpawnDelay)"}
...
scoreboard players set #validate2 calc.dabsu 0
$execute unless data storage dabsu:run form{RequiredPlayerRange:""} store result score #validate2 calc.dabsu run function dabsu:z_private_dialog/batch/link/__set_number {num:"$(RequiredPlayerRange)"}
...
scoreboard players set #validate2 calc.dabsu 0
$execute unless data storage dabsu:run form{SpawnCount:""} store result score #validate2 calc.dabsu run function dabsu:z_private_dialog/batch/link/__set_number {num:"$(SpawnCount)"}
...
scoreboard players set #validate2 calc.dabsu 0
$execute unless data storage dabsu:run form{SpawnRange:""} store result score #validate2 calc.dabsu run function dabsu:z_private_dialog/batch/link/__set_number {num:"$(SpawnRange)"}
