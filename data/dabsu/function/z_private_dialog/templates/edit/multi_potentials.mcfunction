data modify storage dabsu:run dialog.dialog set value {type:"minecraft:multi_action",\
    ...
    actions:[\
        ...
        {label:{text:"Merge Each Entry With...",color:"#ffb7fe"},width:300,tooltip:"Merge any NBT into every SpawnPotential entry of every selected spawner",on_click:{action:"run_command",command:"/trigger trigger.dabsu set 191"}},\
        {label:{text:"Replace SpawnPotential NBT With...",color:"#ffe1b7"},width:300,tooltip:"Replace the §7SpawnPotentials§r key in all selected spawners with your input",on_click:{action:"run_command",command:"/trigger trigger.dabsu set 191"}},\
        {label:{text:"Append To All With...",color:"#dbffc8"},width:300,tooltip:"Append a new SpawnPotential entry to all selected spawners",on_click:{action:"run_command",command:"/trigger trigger.dabsu set 192"}},\
    ],\
