data modify storage dabsu:run dialog.dialog set value {type:"minecraft:multi_action_input_form",\
    ...
    inputs:[\
        ...
        {type:"number_range",key:"range",start:1,end:800,initial:20,label:"Range For \"...Using Range Selection\"",step:1,width:400},\
