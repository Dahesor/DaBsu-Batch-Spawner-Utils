data modify storage dabsu:run dialog.dialog set value {type:"minecraft:multi_action",\
    ...
    actions:[\
        ...
        {label:{text:"Overwrite All...",color:"#ffc575"},width:100,tooltip:"Edit the §7SpawnPotentials§c key as a whole",on_click:{action:"run_command",command:"/trigger trigger.dabsu set 191"}},\
        {label:{text:"Delete All",color:"#ffa4a4"},width:100,tooltip:"§cDelete All Spawn Potentials",on_click:{action:"run_command",command:"/trigger trigger.dabsu set 192"}},\
